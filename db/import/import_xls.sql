...
focount= (select count(*) as count from cl.orgunits where isFunding=true and source_id=8), 
rocount= (select count(*) as count from cl.orgunits where isFunding=false and source_id=8), 
