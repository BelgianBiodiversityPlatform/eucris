...
delete from cl.person_orgunit where source_id=3;
delete from cl.project_person where source_id=3;
delete from cl.project_funding where source_id=3;
delete from cl.project_orgunit where source_id=3;
delete from cl.orgunit_funding where source_id=3;
delete from cl.person_funding where source_id=3;
delete from cl.funding_funding where source_id=3;
delete from cl.orgunit_class where source_id=3;
delete from cl.project_class where source_id=3;
delete from cl.person_class where source_id=3;
delete from cl.funding_class where funding_id in (select id from cl.fundings where source_id=3);

delete from cl.orgunits where source_id=3;
delete from cl.projects where source_id=3;
delete from cl.people where source_id=3;	
delete from cl.fundings where source_id=3;
...
update cl.orgunits ou  set isFunding=true
	from (select orgunit_id from cl.orgunit_funding where source_id=3) as tmp
	where ou.id = tmp.orgunit_id;


UPDATE cl.sources set updated_at=now() where id=3;
update cl.sources source set 
fucount= (select count(*) as count from cl.fundings where source_id=3), 
prcount= (select count(*) as count from cl.projects where source_id=3), 
oucount= (select count(*) as count from cl.orgunits where source_id=3), 
focount= (select count(*) as count from cl.orgunits where source_id=3 and isFunding=true), 
rocount= (select count(*) as count from cl.orgunits where source_id=3 and isFunding=false), 
pecount= (select count(*) as count from cl.people where source_id=3), 
updated_at=now()
where id=3;

UPDATE cl.sources set count=fucount+prcount+oucount+pecount where id=3;
